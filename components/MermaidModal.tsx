    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 backdrop-blur-sm p-4">
      <div className="bg-[#1e1e1e] border border-gray-700 p-6 rounded-xl shadow-2xl w-full max-w-4xl h-[80vh] flex flex-col">
        ...
        <p className="text-sm text-gray-400 mb-4">
          Currently only{" "}
          <strong className="text-gray-300">Flowchart, Sequence,</strong> and{" "}
          <strong className="text-gray-300">Class</strong> Diagrams are
          supported. The other types will be rendered as image in Excalidraw.
        </p>
        ...
        <div className="flex-grow grid grid-cols-1 md:grid-cols-2 gap-4 overflow-hidden">
          ...
          <div className="flex flex-col h-full">
            ...
            <div
              ref={previewRef}
              className="w-full flex-grow p-3 bg-[#121212] rounded-lg border border-gray-600 flex items-center justify-center overflow-auto"
            >
              {error && (
                <div className="text-red-400 p-4 whitespace-pre-wrap">
                  {error}
                </div>
              )}
              {!error && (
        ...
        <div className="flex justify-end mt-4">
          <button
            ...
            disabled={!previewContent || !!error}
            className="px-5 py-2 bg-violet-600 text-white rounded-lg hover:bg-violet-500 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Insert
          </button>
        </div>
